  ...
  return (
    <footer className="bg-[#101010] md:pt-20 pt-5 pb-10 w-full flex justify-center items-center">
      <div className="flex gap-2">
        <a href="mailto:murtaza.akbar@gmail.com" className="bg-[#353535] text-white px-5 py-2 rounded-lg text-sm flex items-center font-medium hover:bg-[#444] transition">
